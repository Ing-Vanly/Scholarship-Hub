...
@section('contents')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="{{ route('admin.user.store') }}" enctype="multipart/form-data" class="col-12">
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('user_id') }}" placeholder="{{ __('Enter User ID') }}">
                                            @error('user_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="required_lable">{{ __('Confirm Password') }}</label>
                                            <input type="password"
